...
WELCOME_TEXT = (
    ...
    "workflow for molecules generated by generative AI models. It helps move "
    "from raw generated SMILES to interpretable candidate tables by checking "
    "chemical validity, public identity, public-database differentiation "
    "signals, descriptor-based ADMET triage, chemical-space position, semantic "
    "biomedical evidence similarity, patent/IP-context evidence triage, and "
    "biopharma translational-positioning outputs for an Alzheimer's disease / "
    "alpha7 nAChR scientific demo. The IP-potential score is only a "
    "computational triage signal and is not a legal opinion or a determination "
    "of patentability, novelty, FTO, ownership, infringement risk, efficacy, "
    "safety, or clinical value."
)
START_GUIDANCE = (
...
def render_biopharma_analytics_page(output_dir: Path) -> None:
    ...
    st.caption(
        "Scientific demo framing: Alzheimer's disease / alpha7 nAChR positive "
        "allosteric modulation. Mock OMOP/RWE content is synthetic "
